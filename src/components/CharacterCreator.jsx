...
function DHCharacterCreator({ onComplete, onCancel }) {
...
function DNDCharacterCreator({ onComplete, onCancel }) {
  const { t } = useTranslation();
  const STEPS = [
...
export default function CharacterCreator({ onComplete, onCancel, systemId = 'dnd5e' }) {
  if (systemId === 'daggerheart') {
    return <DHCharacterCreator onComplete={onComplete} onCancel={onCancel} />;
  }
